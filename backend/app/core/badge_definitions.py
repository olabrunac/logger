...
_reg(BadgeDef("dev", "Desenvolvedora", "Criadora do Logger", "🛠️", "special", rarity="cosmico", special=True))
...
for t in [10, 25, 50, 100, 250, 500, 1000, 2500, 5000]:
    ...
    _reg(BadgeDef(f"movie_{t}", names[t][0], names[t][1], "🎬", "media", t, rarity={10: "bronze", 25: "prata", 50: "ouro", 100: "diamante", 250: "lendario", 500: "imortal", 1000: "arcano", 2500: "celestial", 5000: "cosmico"}[t]))
...
for t in [10, 25, 50, 100, 250, 500, 1000, 2500, 5000]:
    ...
    _reg(BadgeDef(f"series_{t}", names[t][0], names[t][1], "📺", "media", t, rarity={10: "bronze", 25: "prata", 50: "ouro", 100: "diamante", 250: "lendario", 500: "imortal", 1000: "arcano", 2500: "celestial", 5000: "cosmico"}[t]))
...
for t in [10, 25, 50, 100, 250, 500, 1000, 2500, 5000]:
    ...
    _reg(BadgeDef(f"game_{t}", names[t][0], names[t][1], "🎮", "media", t, rarity={10: "bronze", 25: "prata", 50: "ouro", 100: "diamante", 250: "lendario", 500: "imortal", 1000: "arcano", 2500: "celestial", 5000: "cosmico"}[t]))
...
for t in [10, 25, 50, 100, 250, 500, 1000, 2500, 5000]:
    ...
    _reg(BadgeDef(f"book_{t}", names[t][0], names[t][1], "📚", "media", t, rarity={10: "bronze", 25: "prata", 50: "ouro", 100: "diamante", 250: "lendario", 500: "imortal", 1000: "arcano", 2500: "celestial", 5000: "cosmico"}[t]))
...
for t in [1, 5, 10, 25, 50, 100, 250, 500, 1000]:
    ...
    _reg(BadgeDef(f"platina_{t}", names[t][0], names[t][1], "🏆", "platinum", t, rarity={1: "bronze", 5: "prata", 10: "ouro", 25: "diamante", 50: "lendario", 100: "imortal", 250: "arcano", 500: "celestial", 1000: "cosmico"}[t]))
...
for t in [1, 10, 50, 100, 250, 500, 1000]:
    ...
    _reg(BadgeDef(f"review_{t}", names[t][0], names[t][1], "⭐", "reviews", t, rarity={1: "bronze", 10: "prata", 50: "ouro", 100: "diamante", 250: "lendario", 500: "imortal", 1000: "arcano"}[t]))
...
for t in [7, 30, 90, 180, 365, 730, 1095]:
    ...
    _reg(BadgeDef(f"streak_{t}", names[t][0], names[t][1], "🔥", "streak", t, rarity={7: "bronze", 30: "prata", 90: "ouro", 180: "diamante", 365: "lendario", 730: "imortal", 1095: "arcano"}[t]))

_reg(BadgeDef("first_follower", "Primeiro Seguidor", "Tem 1 seguidor", "👥", "social", 1, rarity="bronze"))
_reg(BadgeDef("10_followers", "Popular", "Tem 10 seguidores", "👥", "social", 10, rarity="prata"))
_reg(BadgeDef("50_followers", "Influencer", "Tem 50 seguidores", "👥", "social", 50, rarity="ouro"))
_reg(BadgeDef("100_followers", "Celebridade", "Tem 100 seguidores", "👥", "social", 100, rarity="diamante"))
_reg(BadgeDef("250_followers", "Lenda Social", "Tem 250 seguidores", "👥", "social", 250, rarity="lendario"))
_reg(BadgeDef("500_followers", "Ícone", "Tem 500 seguidores", "👥", "social", 500, rarity="imortal"))
_reg(BadgeDef("first_post", "Primeira Postagem", "Fez 1º post na timeline", "💬", "social", 1, rarity="bronze"))

_reg(BadgeDef("first_log", "Primeiro Log", "Criou seu 1º log", "🎯", "general", 1, rarity="bronze"))
_reg(BadgeDef("total_100", "Dedicado", "100 logs no total", "🏅", "general", 100, rarity="diamante"))
_reg(BadgeDef("total_500", "Obsecado", "500 logs no total", "🏅", "general", 500, rarity="imortal"))
_reg(BadgeDef("total_1000", "Lenda Viva", "1.000 logs no total", "🏅", "general", 1000, rarity="arcano"))
_reg(BadgeDef("omnivoro", "Omnívoro", "Tem logs de filmes, séries, jogos e livros", "🌀", "general", 1, rarity="prata"))
_reg(BadgeDef("fav_5", "Fã de Coração", "5 favoritos", "❤️", "general", 5, rarity="prata"))
_reg(BadgeDef("fav_25", "Colecionador", "25 favoritos", "❤️", "general", 25, rarity="ouro"))
_reg(BadgeDef("fav_100", "Colecionador Expert", "100 favoritos", "❤️", "general", 100, rarity="diamante"))
_reg(BadgeDef("fav_250", "Colecionador Lenda", "250 favoritos", "❤️", "general", 250, rarity="lendario"))
