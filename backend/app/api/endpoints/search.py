            ...
            if query:
                ...
                if type_filter in (None, MediaType.BOOK):
                    try:
                        ...
                        external_results += [_book_to_media(it) for it in raw[:20]]
                    except Exception:
                        pass
